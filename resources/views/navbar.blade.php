        ...
        <div class="mx-auto dropdown-oval-container">
            <div class="dropdown">
                ...
                <button class="dropdown-toggle" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                    <span id="dropdownLabel">Main</span>
                </button>
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    <li><a class="dropdown-item" href="#" onclick="setDropdownLabel('Main')">Main</a></li>
                    <li><a class="dropdown-item" href="main" onclick="setDropdownLabel('Kuwago Cafe 1')">Kuwago Cafe 1</a></li>
                    <li><a class="dropdown-item" href="#" onclick="setDropdownLabel('Kuwago Cafe 2')">Kuwago Cafe 2</a></li>
                    <li><a class="dropdown-item" href="#" onclick="setDropdownLabel('Uddesign')">Uddesign</a></li>
                </ul>
            </div>
        </div>
